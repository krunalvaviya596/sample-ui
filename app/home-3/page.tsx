        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          >
            ...
            <div className="absolute -bottom-4 -left-4 rounded-2xl bg-white p-4 shadow-xl sm:-bottom-6 sm:-left-6 sm:p-5">
              <p className="text-2xl font-bold text-primary sm:text-3xl">98%</p>
              <p className="text-xs text-muted sm:text-sm">Satisfaction Rate</p>
            </div>
            {/* Floating badge */}
          ...
          <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {FEATURED_SERVICES.map(({ name, desc, Icon, color }, i) => (
              <motion.div
                ...
                className="group cursor-pointer rounded-2xl border border-border bg-white p-6 transition-all hover:-translate-y-1 hover:shadow-lg"
              >
                <div
